...
const interval = setInterval(function() {
    refreshMapData('https://api.metro.net/LACMTA/vehicle_positions/all?geojson=true')
  }, refreshTime);
...
window.addEventListener("load", (event) => {
    ...
    fetchDataFromApi('https://api.metro.net/LACMTA/vehicle_positions/all?geojson=true');
});
